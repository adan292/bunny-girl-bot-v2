...
export default {
  ...
  run: async ({ msg, sock, args, usedPrefix, command }) => {
    ...
    const basePrompt = `Tu nombre es ${botname} y parece haber sido creada por Bunny Girl. Tu versión actual es @latest, Tú usas el idioma Español. Llamarás a las personas por su nombre ${username}, te gusta ser divertida, y te encanta aprender. Lo más importante es que debes ser amigable con la persona con la que estás hablando. ${username}`;
    try {
